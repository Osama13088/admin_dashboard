...
<!-- Preloader -->
<div class="preloader">
    <img src="{{ asset('admin/images/logos/favicon.png') }}" alt="loader" class="lds-ripple img-fluid" />
</div>
<div id="main-wrapper">
    <!-- Sidebar Start -->
        ...
        <div><!-- ---------------------------------- -->
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <a href="{{ route('admin.dashboard') }}" class="text-nowrap logo-img">
                    <img src="{{ asset('admin/images/logos/dark-logo.svg') }}" class="dark-logo" alt="Logo-Dark" />
                    <img src="{{ asset('admin/images/logos/light-logo.svg') }}" class="light-logo" alt="Logo-light" />
                </a>
                        ...
                        <nav class="navbar navbar-expand-lg p-0">
                                                                ...
                                                                <div class="position-relative">
                                                                    <a href="../main/app-chat.html"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-chat.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                    ...
                                                                    <a href="../main/app-invoice.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-invoice.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                                                                    ...
                                                                    <a href="../main/app-contact2.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-mobile.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                                                                    ...
                                                                    <a href="../main/app-email.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-message-box.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="position-relative">
                                                                    <a href="../main/page-user-profile.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-cart.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                                                                    ...
                                                                    <a href="../main/app-calendar.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-date.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                                                                    ...
                                                                    <a href="../main/app-contact.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-lifebuoy.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                                                                    ...
                                                                    <a href="../main/app-notes.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="{{ asset('admin/images/svgs/icon-dd-application.svg') }}"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                            ...
                            <div class="d-block d-lg-none">
                                <a href="../main/index.html" class="text-nowrap logo-img">
                                    <img src="{{ asset('admin/images/logos/dark-logo.svg') }}" class="dark-logo"
                                        alt="Logo-Dark" />
                                    <img src="{{ asset('admin/images/logos/light-logo.svg') }}" class="light-logo"
                                        alt="Logo-light" />
                                </a>
                            </div>
                                    ...
                                    <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link nav-icon-hover" href="javascript:void(0)"
                                                ...
                                                <img src="{{ asset('admin/images/svgs/icon-flag-en.svg') }}"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                                ...
                                                <div class="message-body">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                        <div class="position-relative">
                                                            <img src="{{ asset('admin/images/svgs/icon-flag-cn.svg') }}"
                                                                alt="" width="20px" height="20px"
                                                                class="rounded-circle object-fit-cover round-20" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                        <div class="position-relative">
                                                            <img src="{{ asset('admin/images/svgs/icon-flag-fr.svg') }}"
                                                                alt="" width="20px" height="20px"
                                                                class="rounded-circle object-fit-cover round-20" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                        <div class="position-relative">
                                                            <img src="{{ asset('admin/images/svgs/icon-flag-sa.svg') }}"
                                                                alt="" width="20px" height="20px"
                                                                class="rounded-circle object-fit-cover round-20" />
                                                        </div>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link position-relative nav-icon-hover"
                                                ...
                                                <span
                                                    class="popup-badge rounded-pill bg-danger text-white fs-2">2</span>
                                            </a>
                                        </li>
                                        <!-- ------------------------------- -->
                                            ...
                                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                                ...
                                                <div class="message-body" data-simplebar>
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        <span class="me-3">
                                                            <img src="{{ asset('admin/images/profile/user-2.jpg') }}"
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                                        <span class="me-3">
                                                            <img src="{{ asset('admin/images/profile/user-3.jpg') }}"
                                                                alt="user" class="rounded-circle" width="48"
                                                                height="48" />
                                                        </span>
                                                        <div class="w-75 d-inline-block v-middle">
                                                            ...
                                                            <span class="fs-2 d-block text-body-secondary">Salma sent
                                                                you new message</span>
                                                        </div>
                                                    </a>
                                                    <a href="javascript:void(0)"
                                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                                        <span class="me-3">
                                                            <img src="{{ asset('admin/images/profile/user-4.jpg') }}"
                                                                alt="user" class="rounded-circle" width="48"
                                                                height="48" />
                                                        </span>
                                                        <div class="w-75 d-inline-block v-middle">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                                        <span class="me-3">
                                                            <img src="{{ asset('admin/images/profile/user-5.jpg') }}"
                                                                alt="user" class="rounded-circle" width="48"
                                                                height="48" />
                                                        </span>
                                                        <div class="w-75 d-inline-block v-middle">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                                        <span class="me-3">
                                                            <img src="{{ asset('admin/images/profile/user-6.jpg') }}"
                                                                alt="user" class="rounded-circle" width="48"
                                                                height="48" />
                                                        </span>
                                                        <div class="w-75 d-inline-block v-middle">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="py-6 px-7 d-flex align-items-center dropdown-item">
                                                        <span class="me-3">
                                                            <img src="{{ asset('admin/images/profile/user-7.jpg') }}"
                                                                alt="user" class="rounded-circle" width="48"
                                                                height="48" />
                                                        </span>
                                                        <div class="w-75 d-inline-block v-middle">
                                                    ...
                                                    <div class="message-body">
                                                        <a href="../main/page-user-profile.html"
                                                            ...
                                                            <span
                                                                ...
                                                                <img src="{{ asset('admin/images/svgs/icon-account.svg') }}"
                                                        ...
                                                        <a href="../main/app-email.html"
                                                            ...
                                                            <span
                                                                class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                                <img src="{{ asset('admin/images/svgs/icon-inbox.svg') }}"
                                                                    alt="" width="24" height="24" />
                                                            </span>
                                                            <div class="w-75 d-inline-block v-middle ps-3">
                                                        ...
                                                        <a href="../main/app-notes.html"
                                                            ...
                                                            <span
                                                                class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                                                                <img src="{{ asset('admin/images/svgs/icon-tasks.svg') }}"
                                                                    alt="" width="24" height="24" />
                                                            </span>
                                                            <div class="w-75 d-inline-block v-middle ps-3">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="m-n4 unlimited-img">
                                                                        <img src="{{ asset('admin/images/backgrounds/unlimited-bg.png') }}"
                                                                            alt="" class="w-100" />
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
                            ...
                            <nav class="sidebar-nav scroll-sidebar">
                                <div class="offcanvas-header justify-content-between">
                                    <img src="admin/images/logos/favicon.ico" alt="" class="img-fluid" />
                                ...
                                <div class="offcanvas-body h-n80" data-simplebar="" data-simplebar>
                                    <ul id="sidebarnav">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level my-3">
                                                ...
                                                <li class="sidebar-item py-2">
                                                    <a href="../main/app-email.html"
                                                        ...
                                                        <div
                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="admin/images/svgs/icon-dd-message-box.svg"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24" />
                                                        </div>
                                                        <div class="d-inline-block">
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link" href="../main/app-chat.html"
                                                aria-expanded="false">
                                                <span>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item d-none d-xl-block">
                                    <a href="../main/index.html" class="text-nowrap nav-link">
                                        <img src="{{ asset('admin/images/logos/dark-logo.svg') }}" class="dark-logo"
                                            width="180" alt="" />
                                        <img src="{{ asset('admin/images/logos/light-logo.svg') }}"
                                                            ...
                                                            <div class="col-6">
                                                                <div class="position-relative">
                                                                    ...
                                                                    <a href="../main/app-calendar.html"
                                                                        ...
                                                                        <div
                                                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                                            <img src="admin/images/svgs/icon-dd-date.svg"
                                                                                alt="" class="img-fluid"
                                                                                width="24" height="24" />
                                                                        </div>
                                                                        <div class="d-inline-block">
                                                ...
                                                <div class="profile-dropdown position-relative" data-simplebar>
                                                    ...
                                                    <div class="message-body">
                                                        ...
                                                        <a href="../main/app-email.html"
                                                            ...
                                                            <div class="w-75 d-inline-block v-middle ps-3">
                                                                <h6 class="mb-1 fs-3 fw-semibold lh-base">My Inbox
                                                                </h6>
                                                                <span
                    ...
                    <div>
                        ...
                        <nav id="sidebarnavh" class="sidebar-nav scroll-sidebar container-fluid">
                            <ul id="sidebarnav">
                                ...
                                <!-- =================== -->
                                <li class="sidebar-item">
                                    <a class="sidebar-link two-column has-arrow" href="#"
                                        aria-expanded="false">
                                        <span class="rounded-3">
                                            <i class="ti ti-file-text"></i>
                                        </span>
