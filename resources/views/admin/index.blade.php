            ...
            <div class="owl-carousel counter-carousel owl-theme">
                    ...
                    <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin/images/svgs/icon-user-male.svg') }}" width="50"
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin/images/svgs/icon-briefcase.svg') }}" width="50"
                                    height="50" class="mb-3" alt="" />
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin/images/svgs/icon-mailbox.svg') }}" width="50"
                                    height="50" class="mb-3" alt="" />
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin/images/svgs/icon-favorites.svg') }}" width="50"
                                    height="50" class="mb-3" alt="" />
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-success-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin/images/svgs/icon-speech-bubble.svg') }}" width="50"
                                    height="50" class="mb-3" alt="" />
                ...
                <div class="item">
                    <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin/images/svgs/icon-connect.svg') }}" width="50"
                                    height="50" class="mb-3" alt="" />
                    ...
                    <div class="card text-bg-primary border-0 w-100">
                        <div class="card-body pb-0">
                            ...
                            <div class="text-center mt-3">
                                <img src="{{ asset('admin/images/backgrounds/piggy.png') }}" class="img-fluid"
                                    alt="" />
                            </div>
                        </div>
