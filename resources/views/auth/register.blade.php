...
<body>
    ...
    <div id="main-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-7 col-xxl-8">
                        ...
                        <div class="d-none d-xl-flex align-items-center justify-content-center h-n80">
                            <img src="{{ asset('admin/images/backgrounds/login-security.svg') }}" alt=""
                            ...
                            <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                                ...
                                <div class="row">
                                    <div class="col-6 mb-2 mb-sm-0">
                                        <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8"
                                            ...
                                            <img src="{{ asset('admin/images/svgs/google-icon.svg') }}" alt=""
                                    ...
                                    <div class="col-6">
                                        <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8"
                                            href="javascript:void(0)" role="button">
                                            <img src="{{ asset('admin/images/svgs/facebook-icon.svg') }}" alt=""
                                                class="img-fluid me-2" width="18" height="18" />
                                ...
                                <div>
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputRole1" class="form-label">Roles</label>
                                            {{--  <input type="text" class="form-control" id="exampleInputRole1"
                                                aria-describedby="roleHelp" name="role" :value="old('role')"
                                                required />  --}}
        ...
        <script src="{{ asset('admin/js/theme/app.init.js') }}"></script>
        <script src="{{ asset('admin/js/theme/theme.js') }}"></script>
        <script src="{{ asset('admin/js/theme/app.min.js') }}"></script>
        <script src="{{ asset('admin/js/theme/sidebarmenu.js') }}"></script>
