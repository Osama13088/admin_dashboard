...
>
  ...
  <body>
    ...
    <div class="preloader">
      <img
        src="{{ asset('admin/images/logos/favicon.png') }}"
        alt="loader"
        ...
        <div class="position-relative z-index-5">
          <div class="row">
            <div class="col-xl-7 col-xxl-8">
              ...
              >
                <img
                  src="admin/images/logos/dark-logo.svg"
                  class="dark-logo"
                  alt="Logo-Dark"
                />
                <img
                  src="admin/images/logos/light-logo.svg"
                  class="light-logo"
                  alt="Logo-light"
                />
              </a>
              ...
              >
                <img
                  src="admin/images/backgrounds/login-security.svg"
                  alt=""
                  class="img-fluid"
                  width="500"
                />
                ...
                <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                  ...
                  <div class="row">
                    <div class="col-6 mb-2 mb-sm-0">
                      ...
                      >
                        <img
                          src="{{ asset('admin/images/svgs/google-icon.svg') }}"
                          alt=""
                    ...
                    <div class="col-6">
                      ...
                      >
                        <img
                          src="{{ asset('admin/images/svgs/facebook-icon.svg') }}"
                          alt=""
                          class="img-fluid me-2"
                          width="18"
                          height="18"
                  ...
                  <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        aria-describedby="emailHelp" name="email" :value="old('email')" required autofocus 
                      />
                    </div>
                    <div class="mb-4">
        ...
        <div class="offcanvas-body h-n80" data-simplebar>
          ...
          <div class="d-flex flex-row gap-3 customizer-box" role="group">
            ...
            <label class="btn p-9 btn-outline-primary" for="boxed-layout"
              ><i class="icon ti ti-layout-distribute-vertical fs-7 me-2"></i
              >Boxed</label
            >
            ...
            <label class="btn p-9 btn-outline-primary" for="full-layout"
              ><i class="icon ti ti-layout-distribute-horizontal fs-7 me-2"></i
              >Full</label
            >
          </div>
